...
object CommandLineOptions {
  ...
  /**
   * Opt defines a command line option.
   * @param name Used as a map key in the returned options.
   * @param value Initial value is the default, or None; new option instance has the actual.
   * @param help Help string displayed if user asks for help.
   * @param parser Attempt to parse input words. If successful, return new value, rest of args.
   */
  case class Opt(
    name:  String,
    value: Option[String],
